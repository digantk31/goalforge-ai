...
import { Search, ChevronRight, Filter, Loader2, Trash2, AlertTriangle } from 'lucide-react'
      ...
      <div className="space-y-3">
        ...
        {filteredGoals.length === 0 && (
          <div className="text-center py-16">
            <p className="text-zinc-500 text-lg">No goals found.</p>
            <p className="text-zinc-600 text-sm mt-1">Create a new goal to get started.</p>
          </div>
        )}
      </div>
